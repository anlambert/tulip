...
MACRO(TALIPOT_SET_COMPILER_OPTIONS)
  ...
  IF(NOT MSVC) # Visual Studio does not recognize these options
    TALIPOT_SET_CXX_FLAGS("-Wall -Wextra -Wunused -Wno-long-long -Wold-style-cast")
    IF(NOT APPLE)
  ...
  IF(WIN32)
    ...
    IF(MSVC)
      ...
      TALIPOT_SET_CXX_FLAGS("/wd4251 /wd4267 /wd4275 /wd4244 /wd4355 /wd4800 /wd4503 /wd4344 /wd4996")
  ...
  IF(TALIPOT_GENERATE_PLUGINSERVER)
    ...
    IF(PLUGIN_UNPARSED_ARGUMENTS)
      ...
      IF(PLUGIN_UNPARSED_ARGUMENTS)
        ...
        STRING(REPLACE ${TALIPOT_DIR} "" DEST ${PLUGIN_DESTINATION})
        SET(PLUGIN_DESTINATION "${CMAKE_BINARY_DIR}/pluginserver/${PLUGIN_COMPONENT}/${DEST}")
        _INSTALL(DIRECTORY ${PLUGIN_DIRECTORY} DESTINATION ${PLUGIN_DESTINATION})
      ENDIF()
    ...
    ELSE()
      ...
      FOREACH(TARGET ${PLUGIN_TARGETS})
        IF(MINGW)
          _INSTALL(TARGETS ${PLUGIN_TARGETS} RUNTIME DESTINATION ${PLUGIN_DESTINATION})
        ELSE(MINGW)
...
MACRO(TALIPOT_INSTALL_PYTHON_FILES install_suffix)
  FOREACH(PYTHON_FILE ${ARGN})
    ...
    ELSEIF(IS_DIRECTORY ${PYTHON_FILE})
      INSTALL(DIRECTORY ${PYTHON_FILE} DESTINATION ${TalipotPythonModulesInstallDir}/${install_suffix})
    ELSE()
      INSTALL(FILES ${PYTHON_FILE} DESTINATION ${TalipotPythonModulesInstallDir}/${install_suffix})
