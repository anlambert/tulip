...
# CMAKE_FIND_ROOT_PATH_MODE_* are set to ONLY in the CMake platform file for
# emscripten which prevents FIND_* commands to work correctly, so reset them to
# BOTH
IF(EMSCRIPTEN)
...
# There is no dynamic linking with emscripten, add dependencies libraries in the
# TALIPOT_CORE_LIBRARY variable
IF(EMSCRIPTEN)
  FIND_LIBRARY(
    GZSTREAM_TALIPOT_LIBRARY
    "gzstream-talipot-${TALIPOT_MAJOR_VERSION}${TalipotVersionSeparator}${TALIPOT_MINOR_VERSION}"
    PATHS ${TALIPOT_LIBRARIES_DIR} NO_DEFAULT_PATH)
  FIND_LIBRARY(
    YAJL_TALIPOT_LIBRARY
    "yajl-talipot-${TALIPOT_MAJOR_VERSION}${TalipotVersionSeparator}${TALIPOT_MINOR_VERSION}"
    PATHS ${TALIPOT_LIBRARIES_DIR} NO_DEFAULT_PATH)
  SET(TALIPOT_CORE_LIBRARY ${TALIPOT_CORE_LIBRARY} ${GZSTREAM_TALIPOT_LIBRARY}
                           ${YAJL_TALIPOT_LIBRARY})
ENDIF(EMSCRIPTEN)
...
# There is no dynamic linking with emscripten, add dependency library in the
# TALIPOT_OGDF_LIBRARY variable
IF(EMSCRIPTEN)
  FIND_LIBRARY(
    OGDF_TALIPOT_LIBRARY
    "OGDF-talipot-${TALIPOT_MAJOR_VERSION}${TalipotVersionSeparator}${TALIPOT_MINOR_VERSION}"
    PATHS ${TALIPOT_LIBRARIES_DIR} NO_DEFAULT_PATH)
