...
EXECUTE_PROCESS(
  COMMAND ${PYTHON_EXECUTABLE} ${_find_sip_py}
...
IF(sip_config)
  ...
  ELSE()
    ...
    IF(NOT "${SIP_VERSION}" STREQUAL "${LAST_FOUND_SIP_VERSION}")
      MESSAGE(
        STATUS
          "The SIP Python module is installed but its development tools and headers are not. Python bindings can not be compiled with the SIP version installed on the system."
      )
...
ELSE(SIP_FOUND)
  IF(SIP_FIND_REQUIRED)
    MESSAGE(
      FATAL_ERROR "Could not find SIP or its development tools and headers.")
  ENDIF(SIP_FIND_REQUIRED)
ENDIF(SIP_FOUND)

SET(LAST_FOUND_SIP_VERSION
    "${SIP_VERSION}"
    CACHE INTERNAL "")
