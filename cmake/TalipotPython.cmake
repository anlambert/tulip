...
SET(SIP_VERSION_THIRDPARTY 4.19.23)
SET(SIP_OK
    FALSE
    CACHE INTERNAL "")
FIND_PACKAGE(SIP)
...
IF(TALIPOT_ACTIVATE_PYTHON_WHEEL_TARGET)
  STRING(
    REGEX
    REPLACE
      "[^0-9.]" "" TALIPOT_PYTHON_WHEEL_VERSION
  ...
  IF(NOT LINUX)
    ...
    EXECUTE_PROCESS(COMMAND ${PYTHON_EXECUTABLE} -c "import wheel"
                    RESULT_VARIABLE WHEEL_OK OUTPUT_QUIET ERROR_QUIET)
    EXECUTE_PROCESS(COMMAND ${PYTHON_EXECUTABLE} -c "import twine"
                    RESULT_VARIABLE TWINE_OK OUTPUT_QUIET ERROR_QUIET)
  ...
  ELSE(NOT LINUX)
    ...
    ADD_CUSTOM_COMMAND(
      ...
      WORKING_DIRECTORY ${TALIPOT_PYTHON_ROOT_FOLDER}
      COMMENT "patching linux talipot-core wheel"
      VERBATIM)
    ...
    IF(TALIPOT_GENERATE_TESTPYPI_WHEEL)
      ADD_CUSTOM_COMMAND(
        ...
        COMMAND bash -c "rm ./dist/$(ls -t ./dist/ | head -2 | tail -1)"
        WORKING_DIRECTORY ${TALIPOT_PYTHON_ROOT_FOLDER}
        COMMENT "patching linux talipot-core test wheel"
        VERBATIM)
    ENDIF(TALIPOT_GENERATE_TESTPYPI_WHEEL)
