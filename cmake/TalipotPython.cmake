...
IF(TALIPOT_ACTIVATE_PYTHON_WHEEL_TARGET)
  ...
  ELSE(NOT LINUX)
    ...
    IF(EXISTS ${PYTHON_HOME_PATH}/../include/python${PYTHON_VERSION}m)
      SET(PYTHON_INCLUDE_DIR ${PYTHON_HOME_PATH}/../include/python${PYTHON_VERSION}m CACHE PATH "" FORCE)
    ELSE()
      SET(PYTHON_INCLUDE_DIR ${PYTHON_HOME_PATH}/../include/python${PYTHON_VERSION} CACHE PATH "" FORCE)
    ENDIF()
    ...
    EXECUTE_PROCESS(
      COMMAND bash -c "${PYBIN}/pip uninstall -y auditwheel
